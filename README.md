...
## 👀 What is 3WMG ?
3WMG is a hosting account and support management system especially designed to work with MOFH (MyOwnFreeHost). GenerateArea currently has a limited number of features which are listed below:
